...
monkey = Island.create(user: user, name: "Monkey Island", description: "Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type and scrambled it to make a type specimen book.", location: "Bora Bora", price: "£1000")
monkey.photos.attach(io: File.open("/app/assets/images/islands/private-island-Rollins-MT.jpg"), filename: "monkey", content_type: "image/jpeg" )
